...
func main() {
	...
	log.SetPrefix("INFO: ")
	log.Println("This is an info message with a prefix.")

	// Log flags
	log.SetFlags(log.Ldate | log.Ltime | log.Lshortfile)
	log.Println("This is a log message with date, time, and file info.")

	infoLogger.Println("This is an info level log message.")
	warnLogger.Println("This is a warning level log message.")
	errorLogger.Println("This is an error level log message.")
