...
func (lb *LeakyBucket) Allow() bool{
	...
	// elapsedTime = 1.3 sec
	// initial lastLeak = 0 sec
	// tokensToAdd = int(1.3 / 0.5) = int(2.6) = 2 tokens
	// lb.lastLeak = lb.lastLeak + (time.Duration(tokensToAdd) * lb.leakRate) 0 + (2 * 0.5) = 1.0 sec
	// lb.lastLeak = lb.lastLeak + elapsedTime 0 + 1.3
